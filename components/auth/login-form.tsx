...
export function LoginForm({
  ...
  return (
    <form className="grid gap-5" onSubmit={handleSubmit}>
      <div className="rounded-xl border border-border/40 bg-muted/40 px-3.5 py-2.5 text-sm leading-relaxed text-muted-foreground">
        <p>
          Түр зуур турших эрхүүд:
        </p>
        <p>
          Админ: утас <span className="font-mono text-foreground/80">99110011</span>
          , нууц үг <span className="font-mono text-foreground/80">admin</span>
        </p>
        <p>
          Энгийн: утас <span className="font-mono text-foreground/80">88000000</span>
          , нууц үг <span className="font-mono text-foreground/80">1234</span>
        </p>
      </div>
