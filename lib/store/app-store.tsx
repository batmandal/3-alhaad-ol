...
export function AppStoreProvider({ children }: { children: React.ReactNode }) {
  ...
  const value = React.useMemo<AppContextValue>(
    ...
    [users, posts, withdrawals, currentUser, rewardEligibilities, login, signup, logout, addPost, updatePostStatus, verifyFoundAnswer, submitWithdrawal, completeWithdrawal, getUserById]
  )
